...
/* ─── Ring geometry knobs ─────────────────────────────────────────
 * Outer active rectangle: OUTER_W_FRAC * ng  by  OUTER_H_FRAC * ny,
 *                         centered in the ng × ny grid.
 * Inner rectangular hole: INNER_W_FRAC_OF_OUTER  by  INNER_H_FRAC_OF_OUTER
 *                         (fractions of the outer rectangle), also centered.
 * ─────────────────────────────────────────────────────────────── */
#ifndef OUTER_W_FRAC
...
int main(int argc, char* argv[]) {
  ...
  /* ─── Initial condition ───────────────────────────────────────────
  *   All ACTIVE cells (the ring between outer and inner rectangles):
  *     m = (INIT_MX, INIT_MY, INIT_MZ) / |...|   (uniform)
  *   All HOLE cells (outside outer rect, or inside inner rect):
  *     m = 0
  */
  {
